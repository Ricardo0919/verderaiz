...
function Finance() {
    ...
    return (
        <div className="bg-light-beige flex flex-col items-right justify-center relative">
            <div className="z-10">
                <div
                    className="bg-official-mexican-standards mx-10 py-10 mb-20 flex flex-col md:flex-row justify-between items-center md:mx-10 md:py-8 md:gap-8 md:px-4 lg:px-10 xl:mx-20 xl:gap-24 xl:px-20">
