...
import PreventiveReportIMG from "@/assets/images/Services/EnvironmentalImpactProcedures/PreventiveReport/PreventiveReport.png";
import Image from "next/image";
import {useTranslations} from "next-intl";
import servicesBG1 from "@/assets/images/Services/EnvironmentalImpactProcedures/PreventiveReport/servicesBG1.png";

function PreventiveReport() {
    const t = useTranslations("environmentalImpactPreventiveServices");
    return (
        <div className="bg-light-beige flex flex-col justify-center relative">
            ...
            <div className="z-10">
                <div className="text-black md:pt-16 px-10 md:px-20 xl:px-32 lg:pt-24 xl:pt-32">
                    ...
                    <div className="flex flex-col justify-center items-center md:flex-row md:gap-8 md:pb-10">
                        <div className="md:w-1/2 md:order-2">
                            {/*Description*/}
                            <p className="font-montserrat mt-8 md:text-xs lg:text-base font-light xl:text-2xl md:text-right">
                                {t("description1")}
                            </p>
                            <p className="font-montserrat mt-3 md:text-xs lg:text-base font-light xl:text-2xl md:text-right">
                                {t("description2")}
                            </p>
                        </div>
