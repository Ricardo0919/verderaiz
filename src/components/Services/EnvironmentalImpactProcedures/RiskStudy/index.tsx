...
import RiskStudyIMG from "@/assets/images/Services/EnvironmentalImpactProcedures/RiskStudy/RiskStudy.png";
import Image from "next/image";
import {useTranslations} from "next-intl";
import servicesBG2 from "@/assets/images/Services/EnvironmentalImpactProcedures/RiskStudy/servicesBG2.png";

function RiskStudy() {
    const t = useTranslations("environmentalImpactRiskServices");
    return (
        <div className="bg-light-beige flex flex-col justify-center relative">
            ...
            <div className="z-10">
                <div className="text-black md:pt-16 px-10 md:px-20 xl:px-32 lg:pt-24 xl:pt-32">
                    ...
                    <div className="flex flex-col justify-center items-center md:flex-row md:gap-4 md:pb-[80px] md:pt-4">
                        <div className="md:w-1/2">
                            {/*Description*/}
                            <p className="font-montserrat md:text-xs lg:text-base font-light xl:text-2xl">
                                {t("description1")}
                            </p>
