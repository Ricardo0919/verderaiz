...
function EnvironmentalImpact() {
    ...
    return (
        <div className="text-black pt-16 px-10 md:px-20 xl:px-32 lg:pt-24 xl:pt-32 bg-light-beige">
            {/*Title*/}
            <h1 className="text-center font-[1000] font-cambay tracking-[3px] text-3xl md:text-right md:text-4xl lg:tracking-[10px] lg:text-5xl xl:text-6xl md:tracking-[7px] xl:tracking-[18px]">
                {t("title")}
            </h1>
