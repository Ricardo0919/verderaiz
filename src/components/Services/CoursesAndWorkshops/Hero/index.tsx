...
import background from "@/assets/images/Services/CoursesAndWorkshops/Hero/HeroBG.png";
import { useTranslations } from "next-intl";
import Link from "next/link";

function Hero() {
    const t = useTranslations("coursesAndWorkshopsHero");
    const l = useTranslations("navbar");

    return (
        <div className="relative text-center pt-28 pb-16 md:pt-20 md:pb-20 lg:pt-56 lg:pb-24 xl:pb-36">
            {/* Imagen fondo */}
