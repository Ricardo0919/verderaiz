...
import WorkIMG from "@/assets/images/Services/CoursesAndWorkshops/EcoConsicious/WorkIMG.png";
import AdminIMG from "@/assets/images/Services/CoursesAndWorkshops/EcoConsicious/AdminIMG.png";
import EmployeesIMG from "@/assets/images/Services/CoursesAndWorkshops/EcoConsicious/EmployeesIMG.png";
import ProvIMG from "@/assets/images/Services/CoursesAndWorkshops/EcoConsicious/ProvIMG.png";
...
function EcoConsciousContent() {
    const t = useTranslations("coursesAndWorkshopsEcoConscious");

    const sections = [
        { img: WorkIMG, translationKey: "sections.list1" as const, altKey: "sections.work.altText" as const },
        { img: AdminIMG, translationKey: "sections.list2" as const, altKey: "sections.admin.altText" as const },
        { img: EmployeesIMG, translationKey: "sections.list3" as const, altKey: "sections.employees.altText" as const },
        { img: ProvIMG, translationKey: "sections.list4" as const, altKey: "sections.providers.altText" as const }
    ];
    ...
    return (
        <div>
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-8 lg:gap-16 xl:gap-24 my-6 lg:mx-16 mb-12 md:mb-16 xl:mb-24">
                <div className="flex flex-col items-center gap-4">
                    ...
                    />
                    <blockquote className="w-3/5 lg:w-10/12 xl:w-auto text-center italic tracking-widest font-bold uppercase text-black whitespace-pre-line">
                        {t.rich("benefits_quote", {
                            code: (chunks) => (
                                <code className="text-light-green-blog not-italic tracking-widest font-bold uppercase">
                                    {chunks}
                                </code>
                            ),
                        })}
            ...
            <div className="bg-[#e6e8e1] flex flex-col items-center justify-center justify-items-[anchor-center] px-2 lg:px-8 py-8 lg:py-12 rounded-3xl lg:rounded-[48px] mx-10 sm:mx-2 xl:mx-4 mb-12 md:mb-16 xl:mb-24">
                <p className="text-center uppercase font-montserrat font-bold text-black text-xs lg:text-base xl:text-lg mb-8">
                    {t("quote_topics")}
                </p>
                <div className="w-full grid grid-cols-1 lg:grid-cols-2 lg:gap-8 relative items-center text-black font-montserrat">
                    {/* Columna izquierda */}
                    ...
                    <div className="space-y-6 lg:pl-8 mt-8 lg:mt-0 justify-items-center">
                        ...
                        {t.rich("description_topic_list4", {
                            p: (chunks) => <h2 className="font-bold text-base md:text-lg uppercase">{chunks}</h2>,
                            ul: (chunks) => <ul className="list-decimal pl-5">{chunks}</ul>,
                            li: (chunks) => <li>{chunks}</li>,
                            strong: (chunks) => <strong>{chunks}</strong>
                        })}
