...
function EcoConsciousContent() {
    ...
    return (
        <div className="flex flex-col relative">
            <div className="z-10">
                <div className="bg-workshops-green flex flex-col items-center justify-center px-4 lg:px-8 py-8 lg:py-12 rounded-3xl lg:rounded-[48px] mx-2 lg:mx-24 xl:mx-32 mb-12 md:mb-16 xl:mb-24">
                ...
                <div className="bg-workshops-green flex flex-col items-center justify-center px-2 lg:px-8 py-8 lg:py-12 rounded-3xl lg:rounded-[48px] mx-2 sm:mx-2 xl:mx-4 mb-2 md:mb-4">
                    ...
                    <div
                        ...
                        <div className="space-y-6 lg:pr-8 justify-items-center lg:justify-items-start md:px-8 lg:px-0">
                            {t.rich("description_topic_list1", {
                                p: (chunks) => <h2
                                    className="font-[800] font-sans text-base md:text-lg uppercase md:tracking-[3px]">{chunks}</h2>,
                        ...
                        <div className="space-y-6 lg:pl-8 mt-8 lg:mt-0 justify-items-center lg:justify-items-start md:px-8 lg:px-0">
                            ...
                            <div
                                className="hidden lg:block absolute top-0 bottom-0 left-1/2 w-[2px] bg-black"></div>
