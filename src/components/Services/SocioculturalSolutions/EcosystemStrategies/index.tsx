...
import Img1 from "@/assets/images/Services/SocioculturalSolutions/EcosystemStrategies/Img1.png";
import Img2 from "@/assets/images/Services/SocioculturalSolutions/EcosystemStrategies/Img2.png";
import Img3 from "@/assets/images/Services/SocioculturalSolutions/EcosystemStrategies/Img3.png";

function EcosystemStrategies() {
    const t = useTranslations("socioculturalSolutionsEcosystemStrategies");
        ...
        <div className="bg-light-beige py-10 px-4 md:px-8">
            ...
            <div className="block lg:hidden">
                ...
                <div className="hidden lg:block">
                    ...
                    <div className="p-4 flex flex-col items-center justify-center gap-6 w-5/2 pl-8">
...
export default EcosystemStrategies;
