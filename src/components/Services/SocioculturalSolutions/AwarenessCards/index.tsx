...
import Img1 from "@/assets/images/Services/SocioculturalSolutions/AwarenessCards/Img1.png";
import Img2 from "@/assets/images/Services/SocioculturalSolutions/AwarenessCards/Img2.png";
import Img3 from "@/assets/images/Services/SocioculturalSolutions/AwarenessCards/Img3.png";

function AwarenessCards() {
    const t = useTranslations("socioculturalSolutionsAwarenessCards");
            ...
            <div className="z-10">
                ...
                <div className="hidden lg:block z-10">
                    <div className="flex justify-center px-8 xl:px-16 2xl:px-[36rem]">
                        <div
                            className="pr-0 py-4 xl:p-4 flex flex-col items-center justify-center gap-8 xl:gap-10 2xl:gap-12 2xl:pl-12 w-1/2 xl:w-1/3">
