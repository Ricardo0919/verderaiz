...
import EcoDev from "@/assets/images/Services/SocioculturalSolutions/EconomicDevelopment/EconomicDevelopment.png";

function EconomicDevelopment() {
    const t = useTranslations("socioculturalSolutionsEconomicDevelopment");
            ...
            <div className="bg-[#e6e8e1] flex flex-col px-6 md:px-12 lg:px-20 md:py-4 lg:py-8 rounded-3xl lg:rounded-[48px] w-full max-w-7xl">
                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 my-6">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col">
                        <h2 className="font-cambay tracking-[0.32em] uppercase text-black text-center text-sm md:text-xl xl:text-4xl font-semibold mb-6 md:mb-8 lg:mb-2 border-[3px] border-[#263c2c] rounded-2xl lg:rounded-[32px] p-6 sm:p-8">
                            {t('title')}
                        </h2>
