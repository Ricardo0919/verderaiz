...
function NatureSolutions() {
    ...
    return (
        <div className="bg-light-beige flex flex-col items-center justify-center relative py-10 px-4 sm:px-6 lg:px-8">
            <div className="bg-[#e6e8e1] flex flex-col  px-6 md:px-12 lg:px-20 py-2 md:py-4 lg:py-8 rounded-3xl lg:rounded-[48px] w-full max-w-7xl">
                ...
                {/* Descripción 2 */}
                <div className="text-black mb-6 lg:mb-8 font-cambay font-semibold tracking-[0.32em] text-center text-base lg:text-lg xl:text-2xl text-semibold md:mx-12 lg:mx-20">
                    <p>{t('description2')}<strong className="text-[#5e845c]">{t('description2_1')}</strong>{t('description2_2')}</p>
                </div>
