...
import EnvAwarnessBG from "@/assets/images/Services/SocioculturalSolutions/EnvironmentalAwarness/EnvironmentalAwarnessBG.png";
    ...
    return (
        <div className="bg-light-beige flex flex-col items-center justify-center relative py-10 px-4 sm:px-6 lg:px-8">
            <Image
                src={EnvAwarnessBG}
                alt="EnvAwarnessBG"
                className="absolute md:w-2/3 md:left-0 xl:w-1/2"
            />
            <div className="z-10">
                <div
                    className="bg-[#e6e8e1] flex flex-col px-6 md:px-12 lg:px-20 md:py-4 lg:py-8 rounded-3xl lg:rounded-[48px] w-full max-w-7xl">
