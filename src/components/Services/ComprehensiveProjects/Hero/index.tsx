...
import PlantBG from "@/assets/images/Services/ComprehensiveProjects/Hero/PlantBG.png";
import PlantBGLG from "@/assets/images/Services/ComprehensiveProjects/Hero/PlantBGLG.png";
import PlantBGLGEN from "@/assets/images/Services/ComprehensiveProjects/Hero/listonTuercaIngles.png";
import PlantBGLGDE from "@/assets/images/Services/ComprehensiveProjects/Hero/listonTuercaAleman.png";
import PlantBGLGFR from "@/assets/images/Services/ComprehensiveProjects/Hero/listonTuercaFrances.png";
...
function HeroServices() {
    const t = useTranslations("comprehensiveProjectsHero");
    ...
    return (
        <div className="text-center py-28 md:py-20 lg:py-20 bg-verderaiz-green px-6">
            {/* Contenido principal */}
            <div className="border-[4px] border-white rounded-2xl flex flex-col items-center justify-center md:flex-row md:pt-0">
                <div className="mt-32 mb-6 md:order-2 md:w-1/2 md:mt-0 xl:w-1/3 xl:mr-32">
                    <h1 className="font-cambay font-black text-3xl tracking-[4px] md:text-2xl mt-20 md:tracking-[7px] lg:text-4xl lg:tracking-[8px] xl:text-5xl xl:tracking-[9px] uppercase">
                        {t("title")}
                    </h1>
