...
import Agua from "@/assets/images/Services/ComprehensiveProjects/Information/Bote.png";
...
function WasteManagement() {
    ...
    return (
        <div className="bg-light-beige pt-16 md:pt-24 lg:pt-32 pb-10 md:pb-12 lg:pb-16 xl:pb-20">
            {/*Titulo*/}
